...
(() => {
    ...
    FXHud.CarHud = function(data) {
        if (data.show) {
            ...
            if (moveup) {
                ...
                $('#food').animate({top: "14px"}, 'fast');
                $('#water').animate({top: "14px"}, 'fast');
            }
            ...
            if (movedown) {
                ...
                $('#food').animate({top: "230px"}, 'fast');
                $('#water').animate({top: "230px"}, 'fast');
            }
    ...
    FXHud.UpdateHud = function(data) {
        var hideHud = data.show

        if (hideHud) {
            $(".ui-container, .hudcontainer, #hunger-thirst").css("display", "none");
            return;
        }

        if (data.togglehud) {
            $(".ui-container, .hudcontainer").css("display", "block");

            if (data.toggleHungerThirst) {
                $("#hunger-thirst").css("display", "block");
            } else {
                $("#hunger-thirst").css("display", "none");
            }
        } else {
            $(".ui-container, .hudcontainer, #hunger-thirst").css("display", "none");
            return;
        ...
        circleProgress2.value = data.armour;
        if (data.inwater) {
