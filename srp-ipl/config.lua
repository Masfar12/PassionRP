...
--config.casinoCarPark                         = false  -- 1380.000, 200.000, -50.000

config.newDiamondCasino                      = true
...
--
config.bunkerInterior                        = false  -- 892.638, -3245.866, -98.265
config.newBunker                             = true
-- Import/Export
...
-- Yachts
config.gunrunningHeistYacht                  = false  -- 1373.828, 6737.393, 6.707596
config.dignityHeistYacht                     = false  -- -2027.946, -1036.695, 6.707587
config.galaxySuperYacht                      = false  -- -2043.974,-1031.582, 11.981
-- The Rest
...
config.redCarpet                             = false  -- 300.593, 199.759, 104.378
...
config.smugglers                             = false  -- -1266.0, -3014.0, -47.0
...
config.smugglersCraneTint                    = false
config.smugglersModarea                      = false
config.smugglersLightingTintProps            = true
config.smugglersFloor                        = true
config.smugglersFloorDecal                   = true
config.smugglersBedroomTraditional           = false
config.smugglersBedroomModern                = true
config.smugglersOfficeBasic                  = true
config.smugglersOfficeTraditional            = false
config.smugglersOfficeModern                 = false
config.smugglersBedroomBlindsOpen            = true
config.smugglersLightingWallTint             = true
config.smugglersBedroomClutter               = false
config.smugglersShellColor                   = 1
config.smugglerBedroomTintColor              = 1
config.smugglerCraneTintColor                = 1
config.smugglersModareaColor                 = 1
config.smugglersLightTintPropsColor          = 1
config.smugglersFloorDecalColor              = 1
config.smugglersBedRoomModernColor           = 1
config.smugglersOfficeModernColor            = 1
config.smugglersBedRoomBlindOpenColor        = 1
config.smugglersLightingWallTintColor        = 1
]]
config.newSmugglers                          = true
...
config.penthousePattern9                     = false
...
config.penthouseArcadeModern                 = true
config.penthouseArcadeRetro                  = false
...
config.penthouseTintShellColor               = 3 -- 1-3 wall patterns
