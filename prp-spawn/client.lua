...
RegisterNetEvent('prp-spawn:client:openUI')
AddEventHandler('prp-spawn:client:openUI', function(value, new)
...
RegisterNUICallback('setCam', function(data)
    ...
    elseif type == "normal" then
        local campos = PRP.Spawns[location].coords
...
RegisterNUICallback('chooseAppa', function(data)
    ...
    TriggerServerEvent('PRPCore:Server:OnPlayerLoaded')
    TriggerEvent('PRPCore:Client:OnPlayerLoaded')
...
RegisterNetEvent('prp-spawn:client:setupSpawns')
AddEventHandler('prp-spawn:client:setupSpawns', function(cData, new, apps)
    if not new then
        SendNUIMessage({
            action = "setupLocations",
            locations = PRP.Spawns,
