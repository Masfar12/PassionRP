...
$(document).on('click', '#submit-spawn', function(evt){
    ...
    if (spawnType !== "appartment") {
        $.post('http://prp-spawn/spawnplayer', JSON.stringify({
            spawnloc: location,
            typeLoc: spawnType
        }));
    } else {
        $.post('http://prp-spawn/chooseAppa', JSON.stringify({
            appType: location,
        }));
    }
});
...
function setupLocations(locations, myHouses) {
    ...
    $(parent).append('<div class="loclabel" id="location" data-location="null" data-type="lab" data-label="Where will you begin?"><p><span id="null">Where will you begin?</span></p></div>')
...
function setupApps(apps) {
    ...
    $(parent).append('<div class="loclabel" id="location" data-location="null" data-type="lab" data-label="Choose an appartement"><p><span id="null">Choose an Apartment</span></p></div>')
