var InventoryOption = "235, 235, 235";
...
$(document).on("dblclick", ".item-slot", function(e){
    ...
    if(ItemData) {
        Inventory.Close();
        $.post("http://prp-inventory/UseItem", JSON.stringify({
...
$(document).on('click', '.weapon-attachments-back', function(e){
    e.preventDefault();
    $(".weapon-attachments-container").fadeOut(250, function(){
    });
    $("#foldux-inventory").css({"left":"0vw"});
...
function FormatAttachmentInfo(data) {
    $.post("http://prp-inventory/GetWeaponData", JSON.stringify({
        weapon: data.name,
        ...
        if (data.WeaponData.ammotype == "AMMO_RIFLE") {
            ...
            AmmoLabel = "12 Gauge"
        } else if (data.WeaponData.ammotype == "AMMO_MUSKET") {
            AmmoLabel = "Musket ball"
        }
...
function handleAttachmentDrag() {
    ...
    $(".weapon-attachments-remove").droppable({
        ...
        drop: function(event, ui) {
            $.post('http://prp-inventory/RemoveAttachment', JSON.stringify({
                ...
                if (data.Attachments !== null && data.Attachments !== undefined) {
                    if (data.Attachments.length > 0) {
                        ...
                        $(".weapon-attachments-title").html('<span style="font-weight: bold; letter-spacing: .1vh;">This weapon does not have attachments</span>');
                    }
                } else {
                    $("#weapon-attachment-" + AttachmentDraggingData.id).fadeOut(150, function(){
                        $("#weapon-attachment-" + AttachmentDraggingData.id).remove();
...
$(document).on('click', '#weapon-attachments', function(e){
    ...
    if (!Inventory.IsWeaponBlocked(ClickedItemData.name)) {
        ...
        $("#foldux-inventory").animate({
            left: 100+"vw"
        }, 200, function(){
            $("#foldux-inventory").css({"display":"none"})
        });
        ...
        $.post('http://prp-inventory/Notify', JSON.stringify({
...
function section(name, data) {
    return `<p><strong>${name}: </strong><span>${data}</span></p>`;
}
...
function FormatItemInfo(itemData) {
    if (itemData != null && itemData.info != "") {
        if (itemData.name == "id_card") {
            ...
            $(".item-info-description").html('<p><strong>SS: </strong><span>' + itemData.info.citizenid + '</span></p><p><strong>First Name: </strong><span>' + itemData.info.firstname + '</span></p><p><strong>Last Name: </strong><span>' + itemData.info.lastname + '</span></p><p><strong>Date of Birth: </strong><span>' + itemData.info.birthdate + '</span></p><p><strong>Sex: </strong><span>' + gender + '</span></p><p><strong>Nationality: </strong><span>' + itemData.info.nationality + '</span></p>');
        } else if (itemData.name == "driver_license") {
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p><strong>First Name: </strong><span>' + itemData.info.firstname + '</span></p><p><strong>Last Name: </strong><span>' + itemData.info.lastname + '</span></p><p><strong>Date of Birth: </strong><span>' + itemData.info.birthdate + '</span></p><p><strong>Driver Licenses: </strong><span>' + itemData.info.type + '</span></p>');
        } else if (itemData.name == "retailweed") {
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p><strong>First Name: </strong><span>' + itemData.info.firstname + '</span></p><p><strong>Last Name: </strong><span>' + itemData.info.lastname + '</span></p><p><strong>Date of Birth: </strong><span>' + itemData.info.birthdate + '</span></p><p><strong>License: </strong><span>' + itemData.info.type + '</span></p>');
        } else if (itemData.name == "distributorweed") {
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p><strong>First Name: </strong><span>' + itemData.info.firstname + '</span></p><p><strong>Last Name: </strong><span>' + itemData.info.lastname + '</span></p><p><strong>Date of Birth: </strong><span>' + itemData.info.birthdate + '</span></p><p><strong>License: </strong><span>' + itemData.info.type + '</span></p>');
        } else if (itemData.name == "trueoriginalcard") {
            $(".item-info-title").html(`<p>${itemData.label}</p>`)
            $(".item-info-description").html(
                section("First Name", itemData.info.firstname) +
                section("Last Name", itemData.info.lastname) +
                section("Date of Birth", itemData.info.birthdate) +
                section("License", itemData.info.type)
            )
        } else if (itemData.name == "medicinalid") {
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p><strong>First Name: </strong><span>' + itemData.info.firstname + '</span></p><p><strong>Last Name: </strong><span>' + itemData.info.lastname + '</span></p><p><strong>Date of Birth: </strong><span>' + itemData.info.birthdate + '</span></p><p><strong>License: </strong><span>' + itemData.info.type + '</span></p>');
        } else if (itemData.name == "prescription") {
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p><strong>First Name: </strong><span>' + itemData.info.firstname + '</span></p><p><strong>Last Name: </strong><span>' + itemData.info.lastname + '</span></p><p><strong>Date of Birth: </strong><span>' + itemData.info.birthdate + '</span></p><p><strong>Prescription: </strong><span>' + itemData.info.type + '</span></p>');
        } else if (itemData.name == "driftlicense") {
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p><strong>First Name: </strong><span>' + itemData.info.firstname + '</span></p><p><strong>Last Name: </strong><span>' + itemData.info.lastname + '</span></p><p><strong>Date of Birth: </strong><span>' + itemData.info.birthdate + '</span></p><p><strong>Nationality: </strong><span>' + itemData.info.nationality + '</span></p><p><strong>Driver Licenses: </strong><span>' + itemData.info.type + '</span></p>');
        } else if (itemData.name == "driftinstruct") {
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p><strong>First Name: </strong><span>' + itemData.info.firstname + '</span></p><p><strong>Last Name: </strong><span>' + itemData.info.lastname + '</span></p><p><strong>Date of Birth: </strong><span>' + itemData.info.birthdate + '</span></p><p><strong>Nationality: </strong><span>' + itemData.info.nationality + '</span></p><p><strong>Driver Licenses: </strong><span>' + itemData.info.type + '</span></p>');
        }else if (itemData.name == "bwminstruct") {
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p><strong>First Name: </strong><span>' + itemData.info.firstname + '</span></p><p><strong>Last Name: </strong><span>' + itemData.info.lastname + '</span></p><p><strong>Date of Birth: </strong><span>' + itemData.info.birthdate + '</span></p><p><strong>Nationality: </strong><span>' + itemData.info.nationality + '</span></p><p><strong>Driver Licenses: </strong><span>' + itemData.info.type + '</span></p>');
        } else if (itemData.name == "bwmlicense") {
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p><strong>First Name: </strong><span>' + itemData.info.firstname + '</span></p><p><strong>Last Name: </strong><span>' + itemData.info.lastname + '</span></p><p><strong>Date of Birth: </strong><span>' + itemData.info.birthdate + '</span></p><p><strong>Nationality: </strong><span>' + itemData.info.nationality + '</span></p><p><strong>Driver Licenses: </strong><span>' + itemData.info.type + '</span></p>');
            ...
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p><strong>ID: </strong><span>' + itemData.info.id + '</span></p><p><strong>First Name: </strong><span>' + itemData.info.firstname + '</span></p><p><strong>Last Name: </strong><span>' + itemData.info.lastname + '</span></p><p><strong>SS: </strong><span>' + itemData.info.citizenid + '</span></p>');
        } else if (itemData.name == "filled_evidence_bag") {
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            if (itemData.info.type == "casing") {
                $(".item-info-description").html('<p><strong>Exhibit: </strong><span>' + itemData.info.label + '</span></p><p><strong>Type Number: </strong><span>' + itemData.info.ammotype + '</span></p><p><strong>Caliber: </strong><span>' + itemData.info.ammolabel + '</span></p><p><strong>Serial Number: </strong><span>' + itemData.info.serie + '</span></p><p><strong>Crime Scene: </strong><span>' + itemData.info.street + '</span></p><br /><p>' + itemData.description + '</p>');
            }else if (itemData.info.type == "blood") {
                $(".item-info-description").html('<p><strong>Exhibit: </strong><span>' + itemData.info.label + '</span></p><p><strong>Blood Group: </strong><span>' + itemData.info.bloodtype + '</span></p><p><strong>DNA Code: </strong><span>' + itemData.info.dnalabel + '</span></p><p><strong>Crime Scene: </strong><span>' + itemData.info.street + '</span></p><br /><p>' + itemData.description + '</p>');
            }else if (itemData.info.type == "fingerprint") {
                $(".item-info-description").html('<p><strong>Exhibit: </strong><span>' + itemData.info.label + '</span></p><p><strong>Finger Pattern: </strong><span>' + itemData.info.fingerprint + '</span></p><p><strong>Crime Scene: </strong><span>' + itemData.info.street + '</span></p><br /><p>' + itemData.description + '</p>');
            }else if (itemData.info.type == "dna") {
                $(".item-info-description").html('<p><strong>Exhibit: </strong><span>' + itemData.info.label + '</span></p><p><strong>DNA Code: </strong><span>' + itemData.info.dnalabel + '</span></p><br /><p>' + itemData.description + '</p>');
            }
            ...
            if (itemData.info.attachments != null && JSON.stringify(itemData.info.attachments) != "[]") {
                ...
                $(".item-info-description").html('<p><strong>Serial Number: </strong><span>' + itemData.info.serie + '</span></p><p><strong>Ammunition: </strong><span>' + itemData.info.ammo + '</span></p><p><strong>Attachments: </strong><span>' + attachmentString + '</span></p>');
            } else{
...
function handleDragDrop() {
    $(".item-drag").draggable({
        ...
        stop: function() {
            ...
            $("#item-use").css("background", "rgba("+InventoryOption+", 0.08)");
        },
    });
    ...
    $("#item-give").droppable({
        ...
        drop: function(event, ui) {
            fromData = ui.draggable.data("item");
            fromInventory = ui.draggable.parent().attr("data-inventory");
            $.post("http://prp-inventory/CheckGiveItem", JSON.stringify({
                inventory: fromInventory,
                item: fromData,
            }));
        }
    ...
    $("#item-drop").droppable({
        ...
        drop: function(event, ui) {
            ...
            $.post("http://prp-inventory/DropItem", JSON.stringify({
                inventory: fromInventory,
                item: fromData,
...
$(document).on('click', '.CombineItem', function(e){
    ...
    if (combineslotData.toData.combinable.anim != null) {
        $.post('http://prp-inventory/combineWithAnim', JSON.stringify({
        ...
        $.post('http://prp-inventory/combineItem', JSON.stringify({
...
function optionSwitch($fromSlot, $toSlot, $fromInv, $toInv, $toAmount, toData, fromData) {
    ...
    $.post("http://prp-inventory/SetInventoryData", JSON.stringify({
    ...
    if (fromData !== undefined && fromData.amount >= $toAmount) {
        ...
        if((toData != undefined || toData != null) && toData.name == fromData.name && !fromData.unique) {
            ...
            if (fromData.amount == $toAmount) {
                ...
                $toInv.find("[data-slot=" + $toSlot + "]").removeClass("item-nodrag");
                if (newData.rare) {
                    $toInv.find("[data-slot=" + $toSlot + "]").addClass("itemglow")
                } else {
                    $toInv.find("[data-slot=" + $toSlot + "]").removeClass("itemglow")
                }
                ...
                $fromInv.find("[data-slot=" + $fromSlot + "]").removeClass("itemglow");
                ...
                newDataFrom.rare = fromData.rare
                ...
                $fromInv.find("[data-slot=" + $fromSlot + "]").removeClass("item-nodrag");
                if (newDataFrom.rare) {
                    $fromInv.find("[data-slot=" + $fromSlot + "]").addClass("itemglow")
                } else {
                    $fromInv.find("[data-slot=" + $fromSlot + "]").removeClass("itemglow")
                }
            ...
            $.post("http://prp-inventory/PlayDropSound", JSON.stringify({}));
            $.post("http://prp-inventory/SetInventoryData", JSON.stringify({
                fromInventory: $fromInv.attr("data-inventory"),
                toInventory: $toInv.attr("data-inventory"),
                fromSlot: $fromSlot,
            ...
            if (fromData.amount == $toAmount) {
                if (toData != undefined && toData.combinable != null && isItemAllowed(fromData.name, toData.combinable.accept)) {
                    $.post('http://prp-inventory/getCombineItem', JSON.stringify({item: toData.combinable.reward}), function(item){
...
function InventoryError($elinv, $elslot) {
    ...
    $.post("http://prp-inventory/PlayDropFail", JSON.stringify({}));
}
...
(() => {
        ...
        if (data.inventory !== null) {
            $.each(data.inventory, function (i, item) {
                if (item != null) {
                    ...
                    console.log((item.name).split("_")[0]);
                    if ((item.name).split("_")[0] == "weapon") {
                        if (!Inventory.IsWeaponBlocked(item.name)) {
                    ...
                    if (item.rare) {
                        $(".player-inventory").find("[data-slot=" + item.slot + "]").addClass("itemglow");
                    }
                    if (item.slot < 6) {
        ...
        if ((data.other != null && data.other != "") && data.other.inventory != null) {
            $.each(data.other.inventory, function (i, item) {
                if (item != null) {
                    ...
                    if (item.rare) {
                        $(".other-inventory").find("[data-slot=" + item.slot + "]").addClass("itemglow");
                    }
    ...
    Inventory.Close = function() {
        ...
        $("#foldux-inventory").fadeOut(300);
        $(".combine-option-container").hide();
        $(".item-slot").remove();
        if ($("#rob-money").length) {
            $("#rob-money").remove();
        }
        $.post("http://prp-inventory/CloseInventory", JSON.stringify({}));
        ...
        $(".giveitem-container").css("display", "none")
    };
    ...
    Inventory.GiveItem = data => {
        const container = $(".giveitem-container");
        container.html("");
        container.css("display", "block")
        data.closePlayers.forEach(player => {
            container.append(
                "<div class='giveitem-player' data-player='" + JSON.stringify(player) + "' data-item='" + JSON.stringify(data.itemData) + "'>" + 
        ...
        window.addEventListener('message', function(event) {
            switch(event.data.action) {
                ...
                case "toggleHotbar":
                    ...
                    break;
                case "RobMoney":
                    $(".inv-options-list").append('<div class="inv-option-item" id="rob-money"><p>TAKEMONEY</p></div>');
...
$(document).on('click', '#rob-money', function(e){
    ...
    $.post('http://prp-inventory/RobMoney', JSON.stringify({
        TargetId: TargetId
    }));
    $("#rob-money").remove();
});

$(document).on('click', '.giveitem-player', function(e){
    e.preventDefault();
    Inventory.Close()
    const targetData = JSON.parse($(this).attr("data-player"));
    const itemData = JSON.parse($(this).attr("data-item"));
    $.post('http://prp-inventory/GiveItem', JSON.stringify({
        player: targetData,
        item: itemData,
        amount: $("#item-amount").val()
    }));
