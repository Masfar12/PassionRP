...
local boat = nil
local DistanceToBoat = nil
local BoatCoords = nil
...
Citizen.CreateThread(function()
	while true do
		...
		BoatCoords = GetEntityCoords(boat)
		end
		
		if boat ~=nil then
			local PlayerCoords =  GetEntityCoords(ped)
			DistanceToBoat = GetDistanceBetweenCoords(PlayerCoords.x , PlayerCoords.y , PlayerCoords.z , BoatCoords.x , BoatCoords.y , BoatCoords.z , false )
		end

		if DistanceToBoat ~= nil then
			if DistanceToBoat < 5 then
