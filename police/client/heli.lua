...
local supervolito_hash = GetHashKey("supervolito")
...
function IsPlayerInPolmav()
	...
	return IsVehicleModel(vehicle, polmav_hash) or (
		IsVehicleModel(vehicle, supervolito_hash) and GetVehicleNumberPlateText(vehicle):sub(1, #"CIUZ") == "CIUZ"
	)
end
