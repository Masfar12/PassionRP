...
cfg = {
	...
	limpModeMultiplier = 0.40,					-- The torque multiplier to use when vehicle is limping. Sane values are 0.05 to 0.25
...
repairCfg = {
	...
	fixMessages = {
        ...
        "You fixed the oil leak",
        "You replaced the oil tubing which had a leak",
        "You temporarily fixed the oil leaking",
        "You hansome mech! You fixed me :D",
        "You removed some dust and gave it back to the customer with a nice bill",
        "You asked Burt to fix it cause youre too lazy"
    },
    fixMessageCount = 7,

    noFixMessages = {
        "Vehicle has not been repaired succesfully, call in back up.",
        "You tried and failed.. Now Burt is going to scream at you",
        "Wheres Simon if you need him",
        "Still not going to be fixed by looking stupid",
        "nope nope nope",
