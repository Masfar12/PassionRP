...
RegisterNetEvent('prp-admin:client:toggleNoclip')
AddEventHandler('prp-admin:client:toggleNoclip', function()
    toggleNoClipMode()
end)
...
Citizen.CreateThread( function()
    ...
    function handleMovement(xVect,yVect)
        if ( IsControlJustPressed( 1, changeSpeedKey ) or IsDisabledControlJustPressed( 1, changeSpeedKey ) ) then
            ...
            PRPCore.Functions.Notify("Current speed: ".. speeds[travelSpeed])
