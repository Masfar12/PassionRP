...
tables = {
	{
		coords = vector4(1146.0416259766, 266.96929931641, -52.840839385986, 217.49586486816),
		highStakes = false
	},	
	{
		coords = vector4(1148.9992675781, 264.09283447266, -52.840839385986, 35.350288391113),
		highStakes = false
	},	
	{
		coords = vector4(1133.0384521484, 262.2375793457, -52.035732269287, 206.24102783203),
		highStakes = true
	},
}
...
function SetDealerOutfit(ped, outfit)
	local outfit = (outfit % 13) or math.random(6, 13)
