...
RegisterNetEvent('prp-printer:client:UseDocument')
AddEventHandler('prp-printer:client:UseDocument', function(ItemData)
...
RegisterNetEvent('prp-printer:client:SpawnPrinter')
AddEventHandler('prp-printer:client:SpawnPrinter', function(ItemData)
...
Citizen.CreateThread(function()
    while true do
        ...
        if PrinterObject ~= 0 then
            ...
            DrawText3Ds(PrinterCoords.x, PrinterCoords.y, PrinterCoords.z, '~g~E~w~ - Use the printer')
