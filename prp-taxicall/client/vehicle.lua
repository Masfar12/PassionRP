	...
	if IsModelValid(taxiModel) then
		if IsThisModelACar(taxiModel) then
			...
			if not DoesEntityExist(taxiVeh) then
				...
				PRPCore.Functions.Notify('A cab driver is en-route to your location, please dont move. 🚕🚕🚕')
				...
				PRPCore.Functions.Notify(i18n.translate("taxi_contact"), i18n.translate("drivers_busy"))
			end
		end
	end	
end
