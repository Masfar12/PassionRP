...
var PRPCore = {};
var playergroup = false;

emit('PRPCore:GetObject', (obj) => {
    PRPCore = obj
});

on('PRPCore:Client:OnPlayerLoaded', () => {
    var playerdata = PRPCore.Functions.GetPlayerData()
    setTimeout(function(){
    PRPCore.Functions.TriggerCallback("prp-admin:server:hasPermissions", (bool) => {
        if (bool) {
            playergroup = true
        }
        else {
...
const INPUT_VEH_NEXT_RADIO_TRACK = 83;
