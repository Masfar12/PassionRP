...
Config.Shops = {
	vec(325.09439086914, 180.73963928223, 102.58660888672),
}

Config.Control = {
	vec(320.32009887695, 179.94244384766, 104.02848358154),
}

-- OLD
-- vec(1322.6, -1651.9, 51.2),
-- vec(-1153.6, -1425.6, 4.1),
-- vec(-3170.0, 1075.0, 20.1),
-- vec(1864.6, 3747.7, 32.1),
