...
-- You can disable the (F3) menu here / change the keybind.
	...
	MenuKeybind = 178, -- Get the button number here https://docs.fivem.net/game-references/controls/
...
Chairs = {
    [1805980844] =  {type = "chair",  vOffsetX=0.0, vOffsetY=0.0, vOffsetZ=-0.5, direction=180.0, hash = "prop_bench_01a"},
    [1404176808] =  {type = "chair",  vOffsetX=0.0, vOffsetY=0.0, vOffsetZ=-0.5, direction=180.0, hash = "prop_table_04_chr"},
    [-1521264200] =  {type = "chair",  vOffsetX=0.0, vOffsetY=0.0, vOffsetZ=-0.0, direction=180.0, hash = "prop_table_01_chr_a"},
    [2037887057] =  {type = "chair",  vOffsetX=0.0, vOffsetY=0.0, vOffsetZ=-0.5, direction=180.0, hash = "prop_bench_01b"},
    [-1215681419] =  {type = "chair",  vOffsetX=0.0, vOffsetY=0.0, vOffsetZ=-0.5, direction=180.0, hash = "prop_bench_01c"},
    [-628719744] =  {type = "chair",  vOffsetX=0.0, vOffsetY=0.0, vOffsetZ=-0.5, direction=180.0, hash = "prop_bench_02"},
    [-1062810675] =  {type = "chair",  vOffsetX=0.0, vOffsetY=0.0, vOffsetZ=-0.5, direction=180.0, hash = "prop_bench_03"},
    [-763859088] =  {type = "chair",  vOffsetX=0.0, vOffsetY=0.0, vOffsetZ=-0.5, direction=180.0, hash = "prop_bench_04"},
    [-1631057904] = {type = "chair",  vOffsetX=0.0, vOffsetY=0.0, vOffsetZ=-0.5, direction=180.0, hash = "prop_bench_05"},
    [-1317098115] =   {type = "chair",  vOffsetX=0.0, vOffsetY=0.0, vOffsetZ=-0.5, direction=180.0, hash = "prop_bench_06"},
    [-71417349] =   {type = "chair",  vOffsetX=0.0, vOffsetY=0.0, vOffsetZ=-0.5, direction=180.0, hash = "prop_bench_07"},
    [-403891623] =   {type = "chair",  vOffsetX=0.5, vOffsetY=0.2, vOffsetZ=-0.5, direction=180.0, hash = "prop_bench_08"},
    [-99500382] =   {type = "chair",  vOffsetX=0.0, vOffsetY=0.0, vOffsetZ=-0.3, direction=180.0, hash = "prop_bench_09"},
    [536071214] =   {type = "chair",  vOffsetX=0.0, vOffsetY=0.0, vOffsetZ=-0.5, direction=180.0, hash = "prop_off_chair_01"},
    [96868307] =   {type = "chair",  vOffsetX=0.0, vOffsetY=0.0, vOffsetZ=-0.5, direction=180.0, hash = "prop_off_chair_03"},
    [1268458364] =  {type = "chair",  vOffsetX=0.0, vOffsetY=0.0, vOffsetZ=-0.4, direction=180.0, hash = "prop_off_chair_04"},
    [1037469683] =  {type = "chair",  vOffsetX=0.0, vOffsetY=0.0, vOffsetZ=-0.4, direction=180.0, hash = "prop_off_chair_05"},
    [525667351] =   {type = "chair",  vOffsetX=0.0, vOffsetY=0.0, vOffsetZ=-0.5, direction=180.0, hash = "prop_chair_01"},
    [725259233] =   {type = "chair",  vOffsetX=0.0, vOffsetY=0.0, vOffsetZ=-0.5, direction=180.0, hash = "prop_chair_02"},
    [1064877149] =   {type = "chair",  vOffsetX=0.0, vOffsetY=0.0, vOffsetZ=-0.5, direction=180.0, hash = "prop_chair_03"},
    [2064599526] =   {type = "chair",  vOffsetX=0.0, vOffsetY=0.0, vOffsetZ=-0.5, direction=180.0, hash = "prop_chair_04a"},
    [1545434534] =   {type = "chair",  vOffsetX=0.0, vOffsetY=0.0, vOffsetZ=-0.5, direction=180.0, hash = "prop_chair_05"},
    [826023884] =   {type = "chair",  vOffsetX=0.0, vOffsetY=0.0, vOffsetZ=-0.5, direction=180.0, hash = "prop_chair_06"},
    [1056357185] =   {type = "chair",  vOffsetX=0.0, vOffsetY=0.0, vOffsetZ=-0.5, direction=180.0, hash = "prop_chair_07"},
    [1281480215] =   {type = "chair",  vOffsetX=0.0, vOffsetY=0.0, vOffsetZ=0.0, direction=180.0, hash = "prop_chair_08"},
    [291348133] =  {type = "chair",  vOffsetX=0.0, vOffsetY=0.0, vOffsetZ=-0.1, direction=180.0, hash = "prop_skid_chair_01"},
    [1071807406] =  {type = "chair",  vOffsetX=0.0, vOffsetY=0.0, vOffsetZ=-0.1, direction=180.0, hash = "prop_skid_chair_02"},
    [-1118419705] = {type = "chair",  vOffsetX=0.0, vOffsetY=0.0, vOffsetZ=-0.5, direction=180.0, hash = "prop_cs_office_chair"},
    [538002882] =   {type = "chair",  vOffsetX=0.0, vOffsetY=0.0, vOffsetZ=0.1, direction=180.0, hash = "ba_prop_battle_club_chair_01"},
    [-992710074] =  {type = "chair",  vOffsetX=0.0, vOffsetY=0.0, vOffsetZ=-0.55, direction=180.0, hash = "v_med_cor_medstool"},
    [-109356459] =  {type = "chair",  vOffsetX=0.0, vOffsetY=0.0, vOffsetZ=-0.5, direction=180.0, hash = "v_corp_offchair"},
    [-606800174] =  {type = "chair",  vOffsetX=0.0, vOffsetY=0.0, vOffsetZ=-0.5, direction=180.0, hash = "apa_mp_h_din_chair_04"},
    [-1173315865] = {type = "chair",  vOffsetX=0.0, vOffsetY=0.0, vOffsetZ=-0.5, direction=180.0, hash = "p_clb_officechair_s"},
    [438342263] =   {type = "chair",  vOffsetX=0.0, vOffsetY=0.0, vOffsetZ=-0.3, direction=180.0, hash = "v_res_fa_chair01"},
    [867556671] =   {type = "chair",  vOffsetX=0.0, vOffsetY=0.0, vOffsetZ=-0.5, direction=180.0, hash = "v_club_officechair"},
    [-1015375034] = {type = "chair",  vOffsetX=0.0, vOffsetY=0.0, vOffsetZ=-0.5, direction=180.0, hash = "bkr_prop_clubhouse_chair_03"},
    [589738836] =   {type = "chair",  vOffsetX=0.1, vOffsetY=0.0, vOffsetZ=-0.5, direction=180.0, hash = "v_corp_bk_chair3"}, -- scuffed
    [-377849416] =   {type = "chair",  vOffsetX=0.0, vOffsetY=0.0, vOffsetZ=-0.5, direction=180.0, hash = "v_ilev_leath_chr"},
    [1840174940] =   {type = "chair",  vOffsetX=0.0, vOffsetY=0.0, vOffsetZ=-0.7, direction=180.0, hash = "ba_prop_int_glam_stool"},
