...
Config.Settings = {
    ...
    key = 'y', --Customise the key to open the settings UI.
...
Config.Seatbelt = {
    ...
    tyrepop = true, --If enabled, when you are crash hard enough a random tyre will pop.
}

Config.Cruise = {
    ENABLE = true, --The main toggle for the settings. If disabled, all of the options below in this sub-table will not used.
    command = 'cruise', --Customise the chat command to toggle cruise control.
    key = 'RBRACKET', --Customise the key to toggle cruise control.
...
---------------------------------------------- OTHER -------------------------------------------------
------------------------------------------------------------------------------------------------------
Config.HideMiniMap = false --If enabled, the mini-map will be hidden when the player is on foot, but will show when the player is in a car.