$(function() {
    var playerTrack = $("#player-track"),
        ...
        buffInterval = null,
        tFlag = false,
        albums = ['Passion Radio', 'Passion Radio', 'Passion Radio'],
        trackNames = ['Hovey Benjamin - Bangs', 'Hovey Benjamin - Lofi Chill Study Beats', 'Haroinfather - Forever'],
        albumArtworks = ['_1', '_2', '_3'],
        trackUrl = ['audio/1.mp3', 'audio/2.mp3', 'audio/3.mp3'],
