...
Config.LockerRewards = {
    ["tier1"] = {
        {item = "goldchain", maxAmount = 80},
        {item = "rare_coins", maxAmount = 35},
        {item = "cryptostick", maxAmount = 15},
        {item = "diamond", maxAmount = 80},
        {item = "emerald", maxAmount = 80},
    },
    ["tier2"] = {
        {item = "rolex", maxAmount = 65},
        {item = "rolex", maxAmount = 65},
        {item = "rolex", maxAmount = 65},
        {item = "goldbar", maxAmount = 5},
    },
    ["tier3"] = {
        {item = "rare_coins", maxAmount = 99},
        {item = "goldbar", maxAmount = 4},
    },
}
